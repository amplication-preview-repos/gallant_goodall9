...
export class PaymentResolverBase {
  ...
  @graphql.ResolveField(() => Loan, {
    nullable: true,
    name: "loan",
  })
  async getLoan(@graphql.Parent() parent: Payment): Promise<Loan | null> {
    const result = await this.service.getLoan(parent.id);
